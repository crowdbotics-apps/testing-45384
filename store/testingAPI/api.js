...
const testingAPI = axios.create({
  baseURL: "https://testing-45384.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_docs_schema_retrieve(payload) {
  return testingAPI.get(`/api-docs/schema/`, { params: { lang: payload.lang } })
}
function api_v1_login_create(payload) {
  return testingAPI.post(`/api/v1/login/`, payload)
}
...
function rest_auth_registration_resend_email_create(payload) {
  return testingAPI.post(`/rest-auth/registration/resend-email/`, payload)
}
